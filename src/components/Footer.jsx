  ...
  return (
    <footer className="bg-[#171717] text-white border-t border-[#2e2e2e] pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-[#2e2e2e]">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center text-[#a1a1a1] hover:text-white hover:bg-[#333] transition-colors"
                aria-label="GitHub"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center text-[#a1a1a1] hover:text-white hover:bg-[#0070f3] transition-colors"
                aria-label="LinkedIn"
              >
                <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center text-[#a1a1a1] hover:text-white hover:bg-sky-500 transition-colors"
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-9 h-9 rounded-full bg-[#262626] flex items-center justify-center text-[#a1a1a1] hover:text-white hover:bg-pink-600 transition-colors"
