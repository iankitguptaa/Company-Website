    ...
    <section id="home" className="relative min-h-[90vh] flex flex-col justify-between pt-28 sm:pt-36 pb-16 sm:pb-20 overflow-hidden bg-[#08080c]">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          className="w-full h-full object-cover object-center filter contrast-125 brightness-90 transition-all duration-1000 scale-105"
        />
        {/* Soft Vignette Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#08080c]/85 via-[#08080c]/60 to-[#08080c]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(0,112,243,0.15)_0%,rgba(8,8,12,0.85)_80%)]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex-grow flex flex-col justify-center py-6 sm:py-8">
        <div className="text-center max-w-4xl mx-auto space-y-5 sm:space-y-7">
          {/* Top Capsule Badge */}
          <div className="inline-flex items-center gap-2 px-3.5 sm:px-4 py-1.5 rounded-full border border-white/25 bg-black/60 backdrop-blur-md text-[10px] sm:text-xs font-mono text-[#d4d4d4] shadow-2xl animate-fade-in max-w-full">
          ...
          <h1 className="text-3xl sm:text-6xl lg:text-7xl font-black tracking-tight text-white leading-tight sm:leading-[1.05] drop-shadow-2xl">
          ...
          {/* Subheading */}
          <p className="text-sm sm:text-lg md:text-xl text-[#d4d4d4] max-w-2xl mx-auto font-normal leading-relaxed drop-shadow-md px-2">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 pt-2 sm:pt-4">
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-6 sm:px-8 py-3.5 sm:py-4 text-sm font-semibold text-black bg-white rounded-full hover:bg-neutral-100 transition-all transform hover:-translate-y-0.5 active:translate-y-0 glow-white group shadow-2xl"
            >
            ...
            <a
              href="#portfolio"
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 sm:px-8 py-3.5 sm:py-4 text-sm font-semibold text-white bg-black/50 border border-white/25 rounded-full hover:bg-black/70 hover:border-white/40 transition-all backdrop-blur-md shadow-xl"
            >
          ...
          <div className="mt-8 sm:mt-12 max-w-3xl mx-auto text-left">
            <div className="rounded-xl sm:rounded-2xl border border-white/20 bg-[#0d0d12]/95 text-white shadow-2xl backdrop-blur-2xl overflow-hidden">
      ...
      {/* Hero Stats Row */}
      <div className="relative z-10 border-t border-white/15 bg-black/70 backdrop-blur-md py-6 sm:py-8">
