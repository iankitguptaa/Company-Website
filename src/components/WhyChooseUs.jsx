          ...
          {pillars.map((pillar, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group glass-card glass-card-hover rounded-2xl p-6 flex flex-col justify-between border border-white/10 hover:border-white/30"
              >
                <div>
                  <motion.div 
                    whileHover={{ scale: 1.15, rotate: -6 }}
                    className="w-10 h-10 rounded-xl bg-white/10 border border-white/15 flex items-center justify-center mb-4 text-cyan-400 group-hover:bg-cyan-500/10 group-hover:border-cyan-400/40 transition-colors"
                  >
                    <IconComponent className="w-5 h-5" />
                  </motion.div>
                  <h3 className="text-lg font-bold text-white mb-2 group-hover:text-cyan-400 transition-colors">{pillar.title}</h3>
