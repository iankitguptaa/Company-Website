    ...
    <section id="portfolio" className="py-20 sm:py-24 bg-[#0d0d12] scroll-mt-24">
            ...
            >
              ...
              <div className="p-5 sm:p-6 pt-0 border-t border-transparent">
                <button
                  ...
                  className="w-full inline-flex items-center justify-between py-2.5 px-4 rounded-xl bg-white/5 hover:bg-white hover:text-black border border-white/10 text-xs font-semibold text-white transition-all"
                >
      ...
      {selectedProject && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md animate-fade-in">
          <div className="bg-[#0d0d12] border border-white/20 rounded-2xl w-[92vw] max-w-2xl p-5 sm:p-8 space-y-5 sm:space-y-6 max-h-[88vh] overflow-y-auto shadow-2xl relative text-white">
            <button
            ...
            <div className="pt-4 border-t border-white/10 flex flex-col sm:flex-row justify-end gap-2.5">
              <button
                onClick={() => setSelectedProject(null)}
                className="w-full sm:w-auto px-4 py-2.5 text-xs font-semibold text-[#a1a1a1] bg-white/5 rounded-full hover:bg-white/10 text-center"
              >
                Close
              </button>
              <button
                ...
                className="w-full sm:w-auto px-5 py-2.5 text-xs font-semibold text-black bg-white rounded-full hover:bg-neutral-200 glow-white text-center"
              >
