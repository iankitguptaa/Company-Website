  ...
  return (
    <section id="process" className="py-24 bg-[#0d0d12]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2 border-b border-white/10 pb-4 mb-10 overflow-x-auto">
          {processSteps.map((item, index) => (
            <button
              ...
              className={`flex items-center gap-2.5 px-4 py-2.5 rounded-xl text-xs font-semibold transition-all duration-200 whitespace-nowrap ${
                activeStep === index
            ...
            >
              <span
                className={`font-mono text-[11px] px-1.5 py-0.5 rounded ${
                  activeStep === index ? 'bg-black/20 text-black font-bold' : 'bg-white/10 text-[#a1a1a1]'
                }`}
              >
                {item.step}
              </span>
        ...
        <div className="glass-card rounded-2xl p-8 border border-white/15 shadow-2xl">
              ...
              <div className="pt-4 space-y-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                  {processSteps[activeStep].deliverables.map((del, i) => (
                    <div key={i} className="flex items-center gap-2 text-xs font-medium text-white bg-white/5 p-2.5 rounded-xl border border-white/10">
